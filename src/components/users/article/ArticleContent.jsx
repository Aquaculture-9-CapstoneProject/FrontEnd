        ...
        <div className="py-8">
          ...
          <nav className="text-sm text-neutral-2 mb-6">
            <ol className="list-none p-0 inline-flex">
              ...
              <li className="mx-2 mt-1"><RightArrowSVG /></li>
              <li className="hover:underline">
                Artikel dan Berita
              </li>
              <li className="mx-2 mt-1"><RightArrowSVG /></li>
              ...
              <li className="mx-2 mt-1"><RightArrowSVG /></li>
              <li>
                <span className="font-semibold text-primary-5">{articleData.title}</span>
              </li>
            </ol>
          </nav>
          ...
          <header className="mb-8">
            ...
            <div className="text-base text-neutral-2 mt-2">
              <span>{articleData.date}</span> &bull; <span>{articleData.time}</span> &bull;{" "}
